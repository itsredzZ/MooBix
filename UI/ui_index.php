    ...
    <div class="modal-overlay" id="bookingModal">
        <div class="ticket-modal booking-modal-wide">
            ...
            <div id="step-confirm" class="booking-step" style="display:none;">
                <h2>CONFIRMATION</h2>
                <div id="timerContainer" style="background: rgba(228, 143, 111, 0.1); padding: 10px; border-radius: 8px; text-align: center; margin-bottom: 20px; border: 1px dashed var(--accent-salmon);">
                    <p style="margin: 0; font-size: 0.8rem; color: #888;">Selesaikan pembayaran dalam:</p>
                    <div id="timerDisplay" style="font-family: 'Bebas Neue', sans-serif; font-size: 2.5rem; color: #e74c3c;">10:00</div>
                </div>
